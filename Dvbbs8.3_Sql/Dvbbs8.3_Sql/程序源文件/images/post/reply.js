...
function ShowForum_Emot(thepage)
{
	...
	if (thepage!=Emot_PageCount)
	{EmotStr+='<img style="cursor: pointer;" onClick="Emot_PageSize=12;ShowForum_Emot('+(thepage+1)+');" src="Images/post/Next.gif" width="14" height="14" title="下一页">&nbsp;';}
	if (thepage<5 && Emot_PageCount>4)
	{EmotStr+='&nbsp;<img title="插入表情窗口" style="cursor: pointer;" onclick="ShadeDiv.ShowFrame(\'dispEmot.asp?action=disp&amp;&amp;sw=510&amp;sh=auto\');" src="'+EmotPath+Forum_Emot[50]+'" width="30" height="30" title="新表情 悠嘻猴">';}
